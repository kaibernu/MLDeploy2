...
data = pd.read_csv('/Users/kaka/Desktop/Curso_Deploying_Machine_Learning_Models/House_Prices_Streamlit/data.csv')

st.title('Calcule o Preço do Imóvel - Boston/EUA')
